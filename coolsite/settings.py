...
SECRET_KEY = 'django-insecure-n!3=4(vabx&_xoi33r#fw(9q2g)tn21q(hg6_ikuvf5=agc4ab'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')],  # Директория html-шаблонов. В частности для изменения вида ->
        # -> админ-панели
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# LOGIN_REDIRECT_URL = '/'  # Куда перенаправлять пользователя после успешной авторизации

# Айпи, с которыми будет работать django-debug-toolbar
INTERNAL_IPS = [
    '127.0.0.1',
]
...
DEBUG_TOOLBAR_CONFIG = {
    'SHOW_TOOLBAR_CALLBACK': lambda r: False,  # Enables/disables django-debug-toolbar
}
